...
import {
    ...
    Music, Calendar, DollarSign, Ban, Trash2, Eye, Check,
    AlertTriangle
} from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-fade-in pb-20">
            ...
            <div className="flex justify-between items-center border-b border-white/10 pb-4">
                ...
                <div className="flex gap-3">
                    {user.status === "SUSPEND" ? (
                        <button onClick={handleActivateUser} className="px-4 py-2 bg-green-500/10 text-green-500 border border-green-500/20 rounded-lg font-bold uppercase text-xs flex items-center gap-2 hover:bg-green-500/20 transition">
                            <Check size={14} /> Re-activate
                        </button>
                    ) : (
                        <button onClick={handleSuspendUser} className="px-4 py-2 bg-yellow-500/10 text-yellow-500 border border-yellow-500/20 rounded-lg font-bold uppercase text-xs flex items-center gap-2 hover:bg-yellow-500/20 transition">
                            <Ban size={14} /> Suspend
                        </button>
                    )}
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {user.status === "SUSPEND" ? (
                        <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4 flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-sm font-bold uppercase text-yellow-500 tracking-wider">User has been suspended</h3>
