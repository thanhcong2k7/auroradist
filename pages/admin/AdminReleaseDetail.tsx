                                            ...
                                            <div className="flex gap-4 min-w-0">
                                                ...
                                                <div className="min-w-0">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {/* Badges */}
                                                        {track.is_explicit && <span className="px-1.5 py-0.5 rounded bg-red-500/20 text-red-500 text-[8px] font-black border border-red-500/30" title="Explicit Content">EXPLICIT</span>}
                                                        {track.has_lyrics && <span className="px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-500 text-[8px] font-black border border-blue-500/30" title="Has Lyrics">LYRICS</span>}
                                                    </div>
                                                        ...
                                                        <div className="flex flex-wrap gap-1">
                                                            {track.artists?.map((a: any, i: number) => (
                                                                <React.Fragment key={i}>
                                                                    ...
                                                                    {i < track.artists.length - 1 && <span className="text-gray-600">,</span>}
                                                                </React.Fragment>
                                                            ))}
                                                        </div>
