        ...
        <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
            <div className="border-b border-white/5 pb-4 flex justify-between items-end">
                <div>
                  ...
                  <p className="text-gray-600 font-mono text-[10px] uppercase tracking-widest opacity-60">Financial Settlement Node</p>
                </div>
                <button onClick={handleExportCSV} className="text-[10px] font-black uppercase tracking-widest text-blue-500 hover:text-white transition flex items-center gap-2 border border-blue-500/10 px-4 py-2 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 bg-[#080808] border border-blue-500/10 p-8 rounded-2xl relative overflow-hidden group shadow-lg">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-end md:items-center">
                        ...
                        <button 
                            ...
                            className="mt-6 md:mt-0 px-8 py-4 bg-blue-600 text-white font-black uppercase tracking-widest text-[10px] hover:bg-white hover:text-black transition-all rounded-xl shadow-xl flex items-center gap-3 disabled:opacity-30 active:scale-[0.98]"
                        >
                ...
                <div className="space-y-4">
                     <div className="bg-surface border border-white/5 p-6 rounded-2xl flex items-center gap-5">
                        ...
                        <div>
                            <div className="text-[9px] text-gray-600 font-mono uppercase tracking-widest mb-0.5">Pending Clearance</div>
                     ...
                     <div className="bg-surface border border-white/5 p-6 rounded-2xl flex items-center gap-5">
                        ...
                        <div>
                            <div className="text-[9px] text-gray-600 font-mono uppercase tracking-widest mb-0.5">Gross Lifetime</div>
            ...
            <div className="bg-surface border border-white/5 rounded-2xl overflow-hidden shadow-sm">
                <div className="p-5 border-b border-white/5 flex justify-between items-center bg-black/40">
                    <h3 className="font-bold uppercase tracking-widest text-[10px]">Operational Ledger</h3>
                    <span className="text-[9px] font-mono text-gray-600 uppercase tracking-widest">Feed Status: Optimal</span>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-black text-gray-600 font-mono text-[9px] uppercase tracking-widest">
                            <tr>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-md p-4 animate-fade-in">
                    <div className="bg-surface border border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
                        <div className="p-6 border-b border-white/5 flex justify-between items-center bg-black/40">
                            <h3 className="font-bold uppercase tracking-widest text-[10px] text-blue-500">Fund Disbursement</h3>
                        ...
                        <form onSubmit={handleWithdrawalSubmit} className="p-8 space-y-6">
                            <div className="space-y-1">
                                <label className="text-[9px] font-mono text-gray-600 uppercase tracking-widest ml-1">Quantum Allocation (USD)</label>
                                ...
                                <p className="text-[9px] text-gray-700 font-mono mt-2 uppercase tracking-widest text-right">Cap: ${summary?.availableBalance.toFixed(2)}</p>
                            </div>

                            <div className="space-y-3">
                                <label className="text-[9px] font-mono text-gray-600 uppercase tracking-widest ml-1">Endpoint Configuration</label>
                                    ...
                                    {payoutMethods.map(pm => (
                                        <div key={pm.id} onClick={() => setSelectedMethod(pm.id)} className={`p-4 rounded-xl border-2 cursor-pointer transition-all flex items-center justify-between ${selectedMethod === pm.id ? 'bg-blue-600/5 border-blue-500/30' : 'bg-black/40 border-white/5'}`}>
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="text-[10px] font-black uppercase">{pm.name}</p>
                                                    <p className="text-[9px] font-mono text-gray-600">{pm.details}</p>
                                                </div>
                                            </div>
                            ...
                            <div className="bg-blue-500/5 p-4 rounded-xl border border-blue-500/10 flex gap-4 text-[9px] text-gray-500 font-mono uppercase leading-relaxed tracking-widest">
                                <AlertCircle size={18} className="text-blue-500 shrink-0" />
                                Audit required for node verification. Processing latency: 48h-72h.
                            </div>

                            <button type="submit" disabled={requesting || !withdrawAmount || !selectedMethod} className="w-full py-4 bg-blue-600 text-white font-black uppercase text-[10px] tracking-[0.2em] rounded-xl shadow-xl flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-30">
